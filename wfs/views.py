...
from models import Service, FeatureType
import json
...
def getcapabilities(request, service):
    ...
    return render(request, 'wfs/getCapabilities.xml', context, content_type="text/xml")
...
def describefeaturetype(request, service):
    ...
    return render(request, 'wfs/describeFeatureType.xml', context, content_type="text/xml")
...
def getfeature(request, service):
    ...
    return render(request, 'wfs/getFeature.xml', context, content_type="text/xml")
...
def wfs_exception(request, code, locator, parameter=None):
    ...
    context['text'] = text
    return render(request, 'wfs/exception.xml', context, content_type="text/xml")
